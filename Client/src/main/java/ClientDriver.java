...
public class ClientDriver {
  ...
  protected final static int[] REQUEST_LIST = new int[] { 1000, 500_000,  500_000, 500_000, 500_000, 500_000};
  //protected final static int[] NUMTHREADS_LIST = new int[] { 1 ,150, 250, 350, 400};
  //protected final static int[] REQUEST_LIST = new int[] { 100 , 500_000, 500_000, 500_000, 500_000};
  /**
  ...
  //protected final static String URL = "http://34.220.142.11:8080/TwinderA3";
